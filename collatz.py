...
# of the following calculation: At each step calculate the next value 
# by taking the current value and, if it is even, divide it by two,
# but if it is odd, multiply it by three and add one.

#Author:Lonan Keane

#numbers being calculated will be added into list 'numbers'
numbers= []
#input 
...
while number!=1:
   ...
   if number%2==0:
      number//=2 
      numbers.append(number)
   #if number is odd, multiply by 3 and add 1 and add to list
   else: 
